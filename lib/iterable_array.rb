...
class IterableArray
    ...
    @@iterators = [ :each, :reverse_each, :rindex, :collect, :collect!, :map, :map!, :combination, :cycle, :delete_if, :drop_while, :each_index, :index, :find_index, :keep_if, :each_with_index, :reject!, :reject, :select!, :select, :take_while, :count, :fill, :permutation, :repeated_permutation, :repeated_combination, :zip, ]
    ...
    # working:  Array#instance_methods(false) => [:sort_by!, :transpose, :flatten!, :product, :pack]
    ...
    # module SpecialAccessors
        ...
        # untested
        def flatten
            IterableArray.new @array.flatten
        end
